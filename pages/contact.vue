...
<div id="contact-page" class="page-wrapper contact-page content-page">
  <site-hero title="Contact Me" subtitle="Drop me a line." image="/uploads/contact-hero.jpg"></site-hero>
        ...
        <div class="tile is-parent">
          <article class="tile is-child box">
            ...
            <figure class="image is-1by1 ">
              <opti-image :src="require('~/assets/uploads/contact-person.jpg').src" :srcset="
